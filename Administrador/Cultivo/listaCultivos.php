...
<html>
    ...
    <body>
        <div  align="center" >
            <h1 style="color:#036"> Cultivos realizados en Unidad de <?php echo $nombreUni ?> </h1>
            <table class="table" style="width: 100%" border="1" id="customers">
                <tr>
                    <th>	Codigo Clave	</th>
                    <th>	Unidad	</th>
                    <th>	Nombre	</th>
                ...
                <?php
                $cultivos = $perCultivo->cultivoUnidad($uni);
