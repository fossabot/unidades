...
$uni = $_SESSION['unidad'];
$potreros = $perPot->potrerosSC($uni);
?>
<html>
    <head>
        ...
        //Iniciamos el mapa 
            function iniciarMapa() {
                ...
                //Cargamos los datos de los potreros de la unidad
<?php
$i = 0;
            ...
            function ClickPot(datos) {
                ...
                if (estadoP == "SinCultivo") {
                    if (confirm("El Potrero Seleccionado se encuentra sin Cultivo Iniciado. ¿Desea Iniciar un Nuevo Cultivo en él?")) {
                        window.location.href = "../Cultivo/altaCultivo.php?unidad=" + u + "&pot=" + idP + "&nomP=" + nomP + "";
                    }
                } else {
