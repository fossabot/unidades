...
$uni = $_SESSION['unidad'];
$potreros = $perPot->potrerosCC($uni);
?>
<html>
    <head>
            ...
            function ClickPot(datos) {
                ...
                if (estadoP == "SinCultivo") {
                    if (confirm("El Potrero Seleccionado se encuentra sin Cultivo Iniciado. ¿Desea Iniciar un Nuevo Cultivo en él?")) {
                        ...
                        document.getElementById('contenedor').innerHTML = "<a id='link' onClick='ocultar()' href='#'>X</a><iframe class='windowBox' style='display:block; background-color:#CCC;padding: 2em 0em;'  src='../Cultivo/altaCultivo.php?unidad=" + u + "&pot=" + idP + "&nomP=" + nomP + "'></iframe> ";
