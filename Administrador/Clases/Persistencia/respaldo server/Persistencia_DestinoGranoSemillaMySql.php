...
Registrado Por:        ".$Nombre." ".$FechaTxt."" ;
	...
	$sql= "INSERT INTO	destinogranosemilla (NumCosecha	,ObservacionCorte,FechaCosecha	,	Metodo	,	FechaMovimiento	,	Maquina	,FechaCorte	,HoraMovimiento	,	Maquinista	,HoraCorte	,	MaquinaMovi	,	RendimientoSucio,	MaquinaCorte	,	MaquinistaMovi	,	RendimientoLimpio,	MaquinistaCorte, idTarea)	VALUES ('"	. $destinogs->getNumCosecha	()."', '" . $destinogs->getObservacionCorte	()."', '" . $destinogs->getMaquina	()."', '" . $destinogs->getMetodo	()."', '" . $destinogs->getFechaMovimiento	()."', '" . $destinogs->getMaquinista	()."', '" . $destinogs->getFechaCorte	()."', '" . $destinogs->getHoraMovimiento	()."', '" . $destinogs->getRendimientoSucio	()."', '" . $destinogs->getHoraCorte	()."', '" . $destinogs->getMaquinaMovi	()."', '" . $destinogs->getRendimientoLimpio	()."', '" . $destinogs->getMaquinaCorte	()."', '" . $destinogs->getMaquinistaMovi	()."', '" . $destinogs->getMaquinistaCorte	()."', '" . $destinogs->getFechaCosecha	()."', '"  . $ci['idTarea']."')";
